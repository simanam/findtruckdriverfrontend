...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Real-time visibility for truck drivers. See who\'s rolling, waiting, or parked. Anonymous, free, built by drivers for drivers.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Findtruckdriver - Real-Time Trucking Network',
      },
    ],
  },
  twitter: {
    ...
    title: 'Findtruckdriver - The Live Trucking Network',
    description: 'Real-time visibility for truck drivers. See who\'s rolling, waiting, or parked near you.',
    creator: '@findtruckdriver',
    images: ['/og-image.png'],
  },
  robots: {
