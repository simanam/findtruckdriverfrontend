...
import { Search, Loader2, Building2, MapPin, Truck, Users } from "lucide-react";
    ...
    return (
        <div ref={containerRef} className="space-y-3">
            <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-sm font-medium text-slate-300">Search FMCSA Database</span>
            </div>
            ...
            <div className="relative">
                <input
                    ...
                    className="w-full bg-slate-900 border border-slate-700 rounded-lg pl-10 pr-10 py-2.5 text-white placeholder-slate-600 focus:ring-2 focus:ring-sky-500 focus:border-transparent outline-none transition-all text-sm"
                />
            ...
            {showDropdown && results.length > 0 && (
                <div className="bg-slate-900 border border-slate-700 rounded-xl overflow-hidden shadow-xl max-h-72 overflow-y-auto">
            ...
            {showDropdown && results.length === 0 && !searching && query.length >= 2 && (
                <p className="text-xs text-slate-500 py-2">No carriers found. You can enter company info manually below.</p>
            )}
        </div>
    );
}
